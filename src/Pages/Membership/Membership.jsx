    ...
    <section className="pt-16 min-h-screen">
      ...
      <div className="bg-rose-700 w-full text-white">
        <div className="container mx-auto px-3 md:px-6 lg:px-20 xl:px-40 py-20 flex flex-col md:flex-row items-center justify-between gap-10">
          <div>
            <h1 className="md:text-5xl text-3xl font-bold mb-4">Ziffy Membership</h1>
            ...
            {isPremium ? (
              ...
              <div className="space-x-4 space-y-2">
                <button
                  ...
                  className="btn bg-white text-rose-700 hover:bg-gray-100 transition px-6 py-2 rounded-lg font-semibold"
                >
                  $4.99 / Month
                </button>
                <button
      ...
      <div className="container mx-auto px-3 md:px-6 lg:px-20 xl:px-40 py-16">
        <h2 className="md:text-4xl text-3xl text-center font-bold mb-12">
          Premium Features
        </h2>
